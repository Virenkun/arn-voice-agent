...
export const Audio = ({
  ...
  return (
    ...
    >
      <g clipPath="url(#clip0_4418_7999)">
        <path d="M9.67009 13.9199C8.93009 13.9199 8.34009 14.5199 8.34009 15.2599C8.34009 15.9999 8.94009 16.5899 9.67009 16.5899C10.4101 16.5899 11.0101 15.9899 11.0101 15.2599C11.0101 14.5199 10.4101 13.9199 9.67009 13.9199Z" />
