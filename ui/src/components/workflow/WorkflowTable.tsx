...
interface Workflow {
    ...
    /** "single_prompt" for Single Prompt Agents; null/undefined = visual workflow. */
                    ...
                    <TableBody>
                        {workflows.map((workflow) => (
                            ...
                            >
                                ...
                                <TableCell>
                                    {workflow.agent_type === 'single_prompt' ? (
                                        <Badge variant="secondary" className="border-transparent bg-violet-500/15 text-violet-700 dark:text-violet-300">
                                            Single Prompt
                                        </Badge>
                                    ) : (
