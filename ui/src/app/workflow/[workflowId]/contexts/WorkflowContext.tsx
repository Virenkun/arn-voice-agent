...
interface WorkflowContextType {
    ...
    readOnly?: boolean;
    /** UUID of the current workflow — enables agent-scoped tool creation. */
    workflowUuid?: string;
    /** Insert a freshly created tool into the editor's in-memory tools list. */
    onToolCreated?: (tool: ToolResponse) => void;
}
