 ...
 */
export const listOngoingCallsApiV1MonitoringCallsGet = <ThrowOnError extends boolean = false>(options?: Options<ListOngoingCallsApiV1MonitoringCallsGetData, ThrowOnError>) => (options?.client ?? client).get<ListOngoingCallsApiV1MonitoringCallsGetResponses, ListOngoingCallsApiV1MonitoringCallsGetErrors, ThrowOnError>({ url: '/api/v1/monitoring/calls', ...options });
