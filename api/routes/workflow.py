...
class WorkflowListResponse(BaseModel):
    ...
    workflow_uuid: str | None = None
    # "single_prompt" for Single Prompt Agents, else None (visual workflow).
...
async def get_workflows(
    ...
    agent_types = await db_client.get_agent_types_for_workflows(workflow_ids)
    ...
    return [
        WorkflowListResponse(
            ...
            agent_type=agent_types.get(workflow.id),
        )
