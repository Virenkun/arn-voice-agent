...
async def list_tools(
    ...
    Args:
        ...
        workflow_uuid: When set, return org-global tools plus tools scoped to
            this workflow (an agent editor's picker view). When omitted,
            return everything including agent-scoped tools.
