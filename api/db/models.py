...
class ToolModel(Base):
    ...
    # Optional agent scoping: NULL = org-global (visible to every agent),
    # set = visible only in that workflow's tool picker. CASCADE so a deleted
    # agent takes its private tools with it (never silently promote to global).
    workflow_id = Column(
    ...
    __table_args__ = (
        ...
        Index("ix_tools_workflow_id", "workflow_id"),
    )
